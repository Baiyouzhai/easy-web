 ...
 * @since
 */
public class StandardJscriptVariable implements JscriptVariable {
	...
	public StandardJscriptVariable() {
	}

	public StandardJscriptVariable(String name, Object value) throws JscriptException {
		setName(name);
		this.value = value;
	}
	...
	@Override
	public StandardJscriptVariable copy() throws JscriptException {
		return (StandardJscriptVariable) JscriptVariable.super.copy();
	}
