 ...
 * @since 2019年12月20日
 */
public class StandardJscriptFunction extends StandardJscriptInit implements JscriptFunction {
	...
	public StandardJscriptFunction() {
	}

	public StandardJscriptFunction(String name, String codeBlock) throws JscriptException {
		this(name, new String[0], codeBlock);
	}

	public StandardJscriptFunction(String name, String[] argNames, String codeBlock) throws JscriptException {
